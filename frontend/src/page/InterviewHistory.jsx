...
const InterviewHistory = () => {
    ...
    const handleDelete = async (id, e) => {
        ...
        try {
            await axios.delete(
                ServerUrl + `/api/interview/delete/${id}`,
                { withCredentials: true }
            )
                    ...
                    <div className='grid gap-6'>
                        {interviews.map((item, index) => (
                            <div
                                ...
                                className='relative bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100'
                            >
