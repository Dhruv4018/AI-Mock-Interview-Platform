...
import Authhmodels from '../components/authhmodels'
import { useNavigate } from 'react-router-dom'
import { BsRobot, BsMic, BsClock, BsBarChart, BsFileEarmarkText, BsModem } from "react-icons/bs";
...
const Home = () => {
  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Detailed strngths,weaknesses and improvement insights."
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
                    title: "Interview Analytics",
                    desc: "Track your progress and improvements over time."
                  }
                ].map((item, index) => (
                  <motion.div key={index} className='bg-white border border-gray-2 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all '
      ...
      {showAuth && <Authhmodels onClose={() => setShowAuth(false)} />}
