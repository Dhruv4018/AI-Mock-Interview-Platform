...
import AuthModel from './authhmodels';
    ...
    <div className="bg-[#f3f3f3] flex justify-center px-4 pt-6">
      <motion.div
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          ...
          <h1 className='font-semibold hidden md:block text-lg'>InterIQ</h1>
          ...
          <div className='relative'>
            ...
            {showCreditPopup && (
              <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                <p className='text-sm text-gray-600 mb-4'>Need more credits to continue interiews </p>
                <button className='w-full bg-black text-white py-2 rounded-lg text-sm cursor-pointer' onClick={() => navigate("/pricing")}>Buy More Credits</button>
          ...
          <div className='relative'>
            ...
            {showUserPopUp && (
              <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                ...
                <button className='w-full text-left text-sm py-2 flex items-center gap-2 text-red-500 cursor-pointer' onClick={handleLogout}>
