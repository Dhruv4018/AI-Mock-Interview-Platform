...
const Step3Reports = ({ report }) => {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      advice = "Excellent performance. Maintain confidence and structure. Continue  refining clarity and supporting answer with strong real-world examples.";
    } else if (finalScore >= 5) {
      ...
      advice = "Significant improvement required. Focus on structured thinking, clarity, and confident delivery. Practice answering aloud regulary. ";
    }
    ...
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          <button className='mt-1 p-3 rounded-full bg-white shadow hover:shadow-md transition cursor-pointer' onClick={() => navigate("/history")}>
        ...
        <button onClick={downloadPDF} className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap cursor-pointer'>
          Download PDF
        </button>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='bg-white rounded-2xl sm:ronded-3xl shadow-lg p-6 sm:p-8'
          >
