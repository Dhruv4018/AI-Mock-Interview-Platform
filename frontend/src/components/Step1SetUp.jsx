...
import {
  FaUserTie,
  FaBriefcase, FaFileUpload, FaMicrophoneAlt, FaChartLine,
  FaArrowLeft
} from "react-icons/fa"
    ...
    <motion.div
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        <motion.div
          ...
          <button className='mt-1 p-3 rounded-full w-[8%] bg-white shadow hover:shadow-md transition cursor-pointer' onClick={() => navigate("/")}>
          ...
          <div className='space-y-6'>
            ...
            <div className='relative'>
              ...
              <input type='text' placeholder='Enter Role'
                className='w-full pl-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
            ...
            >
              ...
              <option value="Techncal">Technical Interview</option>
            ...
            {!analysisDone && (
              ...
              >
                ...
                {resumeFile && (
                  <motion.button whileHover={{ scale: 1.02 }} className='mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg hover:bg-gray-800 transition cursor-pointer'
                ...
                {skills.length > 0 && (
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {skills.map((s, i) => (
                        <span className='bg-green-100 text-green-70 px-3 py-1 rounded-full text-sm' key={i}>{s}</span>
                      ))}
